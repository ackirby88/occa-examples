...
if [ ${COMPILE_FAIL} == 0 ]; then
  echo " "
  echo -e " ========================================================== "
  echo -e " ${gC}DEMO-C++ build successful! ${eC}"
  echo    "   Compiling Options:"
  echo    "          Build Type: ${BUILD_TYPE}"
  echo    "          Unit Tests: ${UNIT_TEST}"
  echo    " "
  ...
  echo " "
  echo         "========================="
  echo -e "${rC}DEMO-C++ build FAILED!${eC}"
  echo         "========================="
  echo " "
  exit 1
fi
...
cp scripts/util-check-macros.sh bin/.

echo
echo "================================================"
echo -e " Finished Successfully..."
echo -e " Executable: ${GC}builds/demo_release/bin/demo-c++.mpi${eC}"
echo "================================================"

echo -e "Build Script Completed Successfully!"
